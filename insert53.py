...
CT_P_WS3 = current.CT_P_WS3.value

Fetch_WS3_Log = current.Fetch_WS3_Log.value
Fetch_WS3_Log_F = current.Fetch_WS3_Log_F.value

WIP = current.WIP.value
Products_Finished = current.Products_Finished_WS3.value
