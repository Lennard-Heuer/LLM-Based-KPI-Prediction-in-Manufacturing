...
CT_AGV2 = current.CT_AGV2.value
CT_P_AGV2 = current.CT_P_AGV2.value

Fetch_AGV2_Log = current.Fetch_AGV2_Log.value
Fetch_AGV2_Log_F = current.Fetch_AGV2_Log_F.value

WIP = current.WIP.value
Products_Finished = current.Products_Finished_AGV2.value
