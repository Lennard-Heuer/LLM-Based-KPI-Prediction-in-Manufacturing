...
CT_P_WS2 = current.CT_P_WS2.value

Fetch_WS2_Log = current.Fetch_WS2_Log.value
Fetch_WS2_Log_F = current.Fetch_WS2_Log_F.value

WIP = current.WIP.value
Products_Finished = current.Products_Finished_WS2.value
