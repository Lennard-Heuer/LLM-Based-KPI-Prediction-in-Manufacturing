...
CT_P_WS1 = current.CT_P_WS1.value

Fetch_WS1_Log = current.Fetch_WS1_Log.value
Fetch_WS1_Log_F = current.Fetch_WS1_Log_F.value

WIP = current.WIP.value
Products_Finished = current.Products_Finished_WS1.value
